// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SubscriptionDashboardTestFixture.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Tests.IntegrationTests
{
    ...
    /// </summary>
    [TestFixture]
    public class SubscriptionDashboardTestFixture : ApplicationPageTestBase<SubscriptionDashboardPageModel>
    {
        /// <summary>
        /// Gets the display name of the application under test, exactly as it appears in the "View" selector.
        /// </summary>
        protected override string ApplicationName => "Subscription Dashboard";
        ...
        protected override SubscriptionDashboardPageModel CreatePageModel(IPage page) => new(page);
