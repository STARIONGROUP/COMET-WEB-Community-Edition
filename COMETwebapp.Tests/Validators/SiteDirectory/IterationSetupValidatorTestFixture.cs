// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="IterationSetupValidatorTestFixture.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Tests.Validators.SiteDirectory
{
    ...
    [TestFixture]
    public class IterationSetupValidatorTestFixture
    {
        private IterationSetupValidator validator;

        [SetUp]
        public void SetUp()
        {
            var validationService = new ValidationService();
            this.validator = new IterationSetupValidator(validationService);
        }
