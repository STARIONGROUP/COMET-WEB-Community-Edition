// --------------------------------------------------------------------------------------------------------------------
// <copyright file="MultiActualFiniteStateSelectorTestFixture.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Tests.Components.Viewer.Canvas
{
    ...
    public class MultiActualFiniteStateSelectorTestFixture
    {
        ...
        public void SetUp()
        {
            ...
            this.renderedComponent = this.context.Render<MultipleActualFiniteStateSelector>(parameters =>
            {
