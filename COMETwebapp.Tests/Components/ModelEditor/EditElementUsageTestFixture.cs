// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="EditElementUsageTestFixture.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Tests.Components.ModelEditor
{
    ...
    [TestFixture]
    public class EditElementUsageTestFixture
    {
        /// <summary>
        ...
        /// <summary>
        /// The mocked <see cref="IEditElementUsageViewModel" /> bound to the component.
        /// </summary>
        private Mock<IEditElementUsageViewModel> viewModel;
        ...
        /// <summary>
        /// Initializes the bunit context and a mock view model wrapping a fresh <see cref="ElementUsage" />.
        /// </summary>
        [SetUp]
        public void SetUp()
        {
            ...
            this.viewModel = new Mock<IEditElementUsageViewModel>();
            this.viewModel.Setup(x => x.ElementUsage).Returns(new ElementUsage { Iid = Guid.NewGuid() });
            this.viewModel.Setup(x => x.AvailableOptions).Returns(new List<Option>());
        ...
        {
            var writable = this.context.Render<EditElementUsage>(parameters => parameters.Add(p => p.ViewModel, this.viewModel.Object));
            ...
            var readOnly = this.context.Render<EditElementUsage>(parameters => parameters.Add(p => p.ViewModel, this.viewModel.Object));
