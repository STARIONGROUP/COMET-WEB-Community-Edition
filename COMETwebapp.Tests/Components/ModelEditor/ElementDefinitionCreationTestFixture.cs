// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="ElementDefinitionCreationTestFixture.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Tests.Components.ModelEditor
{
    ...
    [TestFixture]
    public class ElementDefinitionCreationTestFixture
    {
        /// <summary>
        ...
        /// <summary>
        /// The mocked <see cref="IElementDefinitionCreationViewModel" /> bound to the component.
        /// </summary>
        private Mock<IElementDefinitionCreationViewModel> viewModel;
        ...
        public void SetUp()
        {
            ...
            this.viewModel = new Mock<IElementDefinitionCreationViewModel>();
        ...
        {
            var writable = this.context.Render<ElementDefinitionCreation>(parameters => parameters.Add(p => p.ViewModel, this.viewModel.Object));
            ...
            var readOnly = this.context.Render<ElementDefinitionCreation>(parameters => parameters.Add(p => p.ViewModel, this.viewModel.Object));
