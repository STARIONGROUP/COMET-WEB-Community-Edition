// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="EditParameterSubscriptionTestFixture.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Tests.Components.ModelEditor
{
    ...
    [TestFixture]
    public class EditParameterSubscriptionTestFixture
    {
        /// <summary>
        ...
        /// <summary>
        /// The mocked <see cref="IEditParameterSubscriptionViewModel" /> bound to the component.
        /// </summary>
        private Mock<IEditParameterSubscriptionViewModel> viewModel;
        ...
        /// <summary>
        /// Initializes the bunit context and a mock view model wrapping a fresh <see cref="ParameterSubscription" />.
        /// </summary>
        [SetUp]
        public void SetUp()
        {
            ...
            this.viewModel = new Mock<IEditParameterSubscriptionViewModel>();
            this.viewModel.Setup(x => x.Subscription).Returns(new ParameterSubscription { Iid = Guid.NewGuid() });
        ...
        {
            var writable = this.context.Render<EditParameterSubscription>(parameters => parameters.Add(p => p.ViewModel, this.viewModel.Object));
            ...
            var readOnly = this.context.Render<EditParameterSubscription>(parameters => parameters.Add(p => p.ViewModel, this.viewModel.Object));
