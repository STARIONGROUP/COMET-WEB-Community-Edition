// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="IndependentParameterTypeFormTestFixture.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Tests.Components.ReferenceData.ParameterTypes
{
    ...
    [TestFixture]
    public class IndependentParameterTypeFormTestFixture
    {
        ...
        public void SetUp()
        {
            ...
            this.item = new IndependentParameterTypeRowViewModel(assignment, "1");

            this.renderer = this.context.Render<IndependentParameterTypeForm>(parameters =>
            {
        ...
        [Test]
        public void VerifyIndependentParameterTypeFormRendering()
        {
            Assert.Multiple(() =>
            {
