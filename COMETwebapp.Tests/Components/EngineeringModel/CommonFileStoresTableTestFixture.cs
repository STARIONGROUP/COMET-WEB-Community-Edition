// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CommonFileStoresTableTestFixture.cs" company="RHEA System S.A.">
...
namespace COMETwebapp.Tests.Components.EngineeringModel
{
    ...
    public class CommonFileStoresTableTestFixture
    {
        ...
        public async Task VerifyEditCommonFileStore()
        {
            ...
            var cancelButton = editForm.FindComponents<DxButton>().First(x => x.Instance.Id == "cancelCommonFileStoreButton");
