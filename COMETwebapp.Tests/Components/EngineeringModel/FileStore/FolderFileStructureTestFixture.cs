...
namespace COMETwebapp.Tests.Components.EngineeringModel.FileStore
{
    ...
    public class FolderFileStructureTestFixture
    {
        ...
        public void SetUp()
        {
            ...
            this.folderHandlerViewModel.Setup(x => x.DomainOfExpertiseSelectorViewModel).Returns(domainSelectorViewModel.Object);
            this.fileHandlerViewModel = new Mock<IFileHandlerViewModel>();
            this.fileHandlerViewModel.Setup(x => x.DomainOfExpertiseSelectorViewModel).Returns(domainSelectorViewModel.Object);
