// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="DomainsOfExpertiseTableViewModelTestFixture.cs" company="Starion Group S.A.">
    ...
    public class DomainsOfExpertiseTableViewModelTestFixture
    {
        ...
        [Test]
         public async Task VerifyRowOperations()
         {
             ...
             this.viewModel.OnDeprecateUnDeprecateButtonClick(domainRow.Thing);
