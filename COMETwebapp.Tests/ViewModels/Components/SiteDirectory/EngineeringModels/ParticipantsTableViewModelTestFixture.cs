// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="ParticipantsTableViewModelTestFixture.cs" company="RHEA System S.A.">
...
namespace COMETwebapp.Tests.ViewModels.Components.SiteDirectory.EngineeringModels
{
    ...
    public class ParticipantsTableViewModelTestFixture
    {
        ...
        public async Task VerifyRowOperations()
        {
            ...
            Assert.Multiple(() =>
            {
                this.sessionService.Verify(x => x.DeleteThing(It.IsAny<EngineeringModelSetup>(), It.IsAny<Participant>()), Times.Once);
