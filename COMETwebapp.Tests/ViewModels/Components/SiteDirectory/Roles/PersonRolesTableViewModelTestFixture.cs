// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="PersonRolesTableViewModelTestFixture.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Tests.ViewModels.Components.SiteDirectory.Roles
{
    ...
    [TestFixture]
    public class PersonRolesTableViewModelTestFixture
    {
        private PersonRolesTableViewModel viewModel;
        private Mock<ISessionService> sessionService;
        private Mock<IPermissionService> permissionService;
        private Mock<IShowHideDeprecatedThingsService> showHideDeprecatedThingsService;
        private Assembler assembler;
        private Mock<ILogger<PersonRolesTableViewModel>> loggerMock;
        ...
        public void Setup()
        {
            ...
            this.loggerMock = new Mock<ILogger<PersonRolesTableViewModel>>();
            ...
            var lazyModel = new Lazy<Thing>(this.personRole);
            ...
            this.viewModel = new PersonRolesTableViewModel(this.sessionService.Object, this.showHideDeprecatedThingsService.Object, this.messageBus, this.loggerMock.Object);
        }
        ...
        public void VerifyInitializeViewModel()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(this.viewModel.Rows.Items.First().Thing, Is.EqualTo(this.personRole));
                Assert.That(this.viewModel.PersonAccessKinds, Is.Not.Empty);
            });
        }
        ...
        public void VerifyParticipantRoleRowProperties()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(participantRoleRow.Name, Is.EqualTo(this.personRole.Name));
                Assert.That(participantRoleRow.ShortName, Is.EqualTo(this.personRole.ShortName));
                Assert.That(participantRoleRow.Thing, Is.EqualTo(this.personRole));
        ...
        public void VerifySessionRefresh()
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                this.permissionService.Verify(x => x.CanWrite(personRoleTest.ClassKind, It.IsAny<Thing>()), Times.AtLeast(this.viewModel.Rows.Count));
            });
        }
