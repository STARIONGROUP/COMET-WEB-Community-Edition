...
namespace COMETwebapp.Tests.ViewModels.Components.ModelEditor
{
    ...
    public class ElementBaseTreeRowViewModelTestFixture
    {
        ...
        {
            var testVM = new ElementbaseTreeViewModelTest(this.elementBase);
        ...
        {
            Assert.That(() => new ElementbaseTreeViewModelTest(null), Throws.ArgumentNullException);
        }

        [Test]
        public void VerifyCreationAndUpdateProperties()
        {
            var testVM = new ElementbaseTreeViewModelTest();
            ...
            testVM.UpdateProperties(new ElementbaseTreeViewModelTest(this.elementBase));
        ...
        {
            Assert.That(() => new ElementbaseTreeViewModelTest(this.elementBase).UpdateProperties(null), Throws.ArgumentNullException);
            Assert.That(() => new ElementbaseTreeViewModelTest().UpdateProperties(null), Throws.ArgumentNullException);
        }
    }

    public class ElementbaseTreeViewModelTest : ElementBaseTreeRowViewModel
    {
        public ElementbaseTreeViewModelTest(ElementBase elementBase) : base(elementBase)
        {
        }

        public ElementbaseTreeViewModelTest()
        {
        }
    }
}
