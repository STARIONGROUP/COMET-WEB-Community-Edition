...
namespace COMET.Web.Common.Tests.Services.SessionManagement
{
    ...
    public class AuthenticationServiceTestFixture
    {
        ...
        public async Task VerifyLoginWithDefinedScheme()
        {
            ...
            var loginResult = await this.authenticationService.Login(AuthenticationSchemeKind.Basic, authenticationInfo);
            Assert.That(loginResult.IsSuccess, Is.EqualTo(false));
            ...
            loginResult = await this.authenticationService.Login(AuthenticationSchemeKind.Basic, authenticationInfo);
            ...
            loginResult = await this.authenticationService.Login(AuthenticationSchemeKind.LocalJwtBearer, tokenBasedAuthenticationInfo);
            ...
            loginResult = await this.authenticationService.Login(AuthenticationSchemeKind.ExternalJwtBearer, tokenBasedAuthenticationInfo);
        ...
        public async Task VerifyRetrieveLastUsedServerUrl()
        {
            ...
            await Assert.ThatAsync(() => this.authenticationService.RetrieveLastUsedServerUrl(), Is.Null);
            ...
            await Assert.ThatAsync(() => this.authenticationService.RetrieveLastUsedServerUrl(), Is.EqualTo(serverUrl));
        }
