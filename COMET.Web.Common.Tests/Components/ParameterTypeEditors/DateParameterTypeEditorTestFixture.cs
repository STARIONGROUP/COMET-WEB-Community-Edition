// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="DateParameterTypeEditorTestFixture.cs" company="Starion Group S.A.">
...
namespace COMET.Web.Common.Tests.Components.ParameterTypeEditors
{
    ...
    public class DateParameterTypeEditorTestFixture
    {
        ...
        public void SetUp()
        {
            ...
            this.renderedComponent = this.context.Render<DateParameterTypeEditor>(parameters => { parameters.Add(p => p.ViewModel, this.viewModelMock.Object); });
