// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Wedge.cs" company="RHEA System S.A.">
...
namespace COMETwebapp.Primitives
{
    ...
    /// <summary>
    /// Wedge primitive type
    /// </summary>
    public class Wedge : BasicPrimitive
    {
        /// <summary>
        /// Basic type name
        /// </summary>
        public override string Type { get; protected set; } = "Wedge";
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="Wedge"/> class
        /// </summary>
        /// <param name="width">the width of the wedge</param>
        /// <param name="height">the height of the wedge</param>
        /// <param name="depth">the depth of the wedge</param>
        public Wedge(double width, double height, double depth)
        {
            this.Width = width;
            this.Height = height;
            this.Depth = depth;
