// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="DependentParameterTypeForm.razor.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Components.ReferenceData.ParameterTypes
{
    ...
    /// <summary>
    /// Support class for the <see cref="DependentParameterTypeForm" /> component.
    /// </summary>
    public partial class DependentParameterTypeForm : SelectedDataItemForm
    {
        /// <summary>
        /// Gets or sets the <see cref="DependentParameterTypeAssignment" /> item being created or edited.
        /// </summary>
        [Parameter]
        public DependentParameterTypeAssignment Item { get; set; }
