// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="ComponentForm.razor.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Components.ReferenceData.ParameterTypes
{
    ...
    /// <summary>
    /// Support class for the <see cref="ComponentForm" /> component.
    /// </summary>
    public partial class ComponentForm : SelectedDataItemForm
    {
        /// <summary>
        /// Gets or sets the <see cref="ParameterTypeComponent" /> item being created or edited.
        /// </summary>
        [Parameter]
        public ParameterTypeComponent Item { get; set; }
