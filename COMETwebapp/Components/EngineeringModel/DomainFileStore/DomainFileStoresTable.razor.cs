// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="DomainFileStoresTable.razor.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Components.EngineeringModel.DomainFileStore
{
    ...
    /// <summary>
    /// Support class for the <see cref="DomainFileStoresTable" />
    /// </summary>
    public partial class DomainFileStoresTable : SelectedDataItemBase<DomainFileStore, DomainFileStoreRowViewModel>
    {
        /// <summary>
        ...
        protected override void OnSelectedDataItemChanged(DomainFileStoreRowViewModel row)
        {
