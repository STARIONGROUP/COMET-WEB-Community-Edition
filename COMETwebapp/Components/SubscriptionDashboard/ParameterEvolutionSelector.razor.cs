// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="ParameterEvolutionSelector.razor.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Components.SubscriptionDashboard
{
    ...
    /// <summary>
    /// Partial class for the <see cref="ParameterEvolutionSelector"/> component
    /// </summary>
    public partial class ParameterEvolutionSelector
    {
        /// <summary>
