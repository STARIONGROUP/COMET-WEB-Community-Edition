// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="DateParameterEvolution.razor.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Components.SubscriptionDashboard
{
    ...
    /// <summary>
    /// Component that display the evolution of a <see cref="ParameterSubscriptionRowViewModel" /> of type <see cref="DateParameterType" />
    /// </summary>
    public partial class DateParameterEvolution
    {
        /// <summary>
