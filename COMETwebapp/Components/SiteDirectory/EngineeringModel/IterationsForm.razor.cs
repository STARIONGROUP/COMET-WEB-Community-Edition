// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="IterationsForm.razor.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Components.SiteDirectory.EngineeringModel
{
    ...
    /// <summary>
    /// Support class for the <see cref="IterationsForm" />
    /// </summary>
    public partial class IterationsForm : SelectedDataItemForm
    {
        /// <summary>
        ...
        {
            await this.ViewModel.CreateOrEditIteration(this.ShouldCreate);
