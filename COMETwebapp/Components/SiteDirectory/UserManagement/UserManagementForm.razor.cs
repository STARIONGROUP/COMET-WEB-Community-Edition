// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="UserManagementForm.razor.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Components.SiteDirectory.UserManagement
{
    ...
    /// <summary>
    /// Support class for the <see cref="UserManagementForm" />
    /// </summary>
    public partial class UserManagementForm : SelectedDataItemForm
    {
        /// <summary>
