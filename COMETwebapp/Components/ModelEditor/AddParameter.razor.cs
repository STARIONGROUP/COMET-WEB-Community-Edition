// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="AddParameter.razor.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Components.ModelEditor
{
    ...
    /// <summary>
    /// Partial class for the component <see cref="AddParameter" />
    /// </summary>
    public partial class AddParameter : DisposableComponent
    {
        ...
        /// </summary>
        [Parameter]
        public IAddParameterViewModel ViewModel { get; set; }
