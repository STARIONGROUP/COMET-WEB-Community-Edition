...
namespace COMETwebapp.ViewModels.Components.Common.OpenTab
{
    ...
    /// </summary>
    public class OpenTabViewModel : DisposableObject, IOpenTabViewModel
    {
        /// <summary>
        ...
        public OpenTabViewModel(ISessionService sessionService, IConfigurationService configurationService)
        {
