// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IPersonRolesTableViewModel.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.ViewModels.Components.SiteDirectory.Roles
{
    ...
    /// <summary>
    /// View model used to manage <see cref="PersonRole" />
    /// </summary>
    public interface IPersonRolesTableViewModel : IDeprecatableDataItemTableViewModel<PersonRole, PersonRoleRowViewModel>
    {
        /// <summary>
