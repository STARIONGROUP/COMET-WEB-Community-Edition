...
namespace COMETwebapp.ViewModels.Components.SiteDirectory.Rows
{
    ...
    /// <summary>
    /// Row View Model for <see cref="IterationSetup" />s
    /// </summary>
    public class IterationSetupRowViewModel : BaseDataItemRowViewModel<IterationSetup>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IterationSetupRowViewModel" /> class.
        /// </summary>
        /// <param name="iterationSetup">The associated <see cref="IterationSetup" /></param>
        public IterationSetupRowViewModel(IterationSetup iterationSetup) : base(iterationSetup)
        {
            this.Name = "Iteration " + iterationSetup.IterationNumber;
            this.Number = iterationSetup.IterationNumber.ToString();
        }

        /// <summary>
        /// The <see cref="IterationSetup" /> number
        /// </summary>
