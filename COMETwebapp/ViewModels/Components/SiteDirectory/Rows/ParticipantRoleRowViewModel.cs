...
namespace COMETwebapp.ViewModels.Components.SiteDirectory.Rows
{
    ...
    /// </summary>
    public class ParticipantRoleRowViewModel : DeprecatableDataItemRowViewModel<ParticipantRole>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParticipantRoleRowViewModel" /> class.
        /// </summary>
        /// <param name="participantRole">The associated <see cref="ParticipantRole" /></param>
        public ParticipantRoleRowViewModel(ParticipantRole participantRole) : base(participantRole)
        {
        }
    }
}
