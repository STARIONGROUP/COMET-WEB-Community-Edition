...
namespace COMETwebapp.ViewModels.Components.Shared.ParameterEditors
{
    ...
    public class TextParameterTypeEditorViewModel : ParameterTypeEditorBaseViewModel<TextParameterType>
    {
        ...
        public TextParameterTypeEditorViewModel(TextParameterType parameterType, IValueSet valueSet, bool isReadOnly, int compoundIndex = -1) : base(parameterType, valueSet, isReadOnly, compoundIndex)
        {
        }
