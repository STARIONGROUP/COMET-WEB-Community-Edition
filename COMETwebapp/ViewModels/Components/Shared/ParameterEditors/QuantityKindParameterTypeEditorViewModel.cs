...
namespace COMETwebapp.ViewModels.Components.Shared.ParameterEditors
{
    ...
    public class QuantityKindParameterTypeEditorViewModel : ParameterTypeEditorBaseViewModel<QuantityKind>
    {
        ...
        public QuantityKindParameterTypeEditorViewModel(QuantityKind parameterType, IValueSet valueSet, bool isReadOnly, int compoundIndex = -1) : base(parameterType, valueSet, isReadOnly, compoundIndex)
        {
