// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="FolderValidator.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Validators.EngineeringModel
{
    ...
    /// <summary>
    /// A class to validate the <see cref="FolderValidator"/>
    /// </summary>
    public class FolderValidator : AbstractValidator<Folder>
    {
        ...
        public FolderValidator(IValidationService validationService) : base()
        {
            ...
            this.RuleFor(x => x.Owner).Validate(validationService, nameof(Folder.Owner));
            this.RuleFor(x => x.ContainingFolder).Validate(validationService, nameof(Folder.ContainingFolder));
        }
    }
}
