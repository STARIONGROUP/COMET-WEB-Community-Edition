// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="CommonFileStoreValidator.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Validators.EngineeringModel
{
    ...
    /// <summary>
    /// A class to validate the <see cref="CommonFileStore"/>
    /// </summary>
    public class CommonFileStoreValidator : AbstractValidator<CommonFileStore>
    {
        ...
        public CommonFileStoreValidator(IValidationService validationService) : base()
        {
            ...
            this.RuleFor(x => x.Owner).Validate(validationService, nameof(CommonFileStore.Owner));
        }
    }
}
