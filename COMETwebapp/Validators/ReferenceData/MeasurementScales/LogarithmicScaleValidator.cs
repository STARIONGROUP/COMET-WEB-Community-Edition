...
// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="LogarithmicScaleValidator.cs" company="RHEA System S.A.">
...
namespace COMETwebapp.Validators.ReferenceData.MeasurementScales
{
    ...
    /// <summary>
    /// A class to validate the <see cref="LogarithmicScale"/>
    /// </summary>
    public class LogarithmicScaleValidator : AbstractValidator<LogarithmicScale>
    {
        /// <summary>
        /// Instantiates a new <see cref="LogarithmicScaleValidator"/>
        /// </summary>
        public LogarithmicScaleValidator(IValidationService validationService) : base()
        {
