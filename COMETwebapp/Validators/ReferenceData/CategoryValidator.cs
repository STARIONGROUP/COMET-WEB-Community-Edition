// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="CategoryValidator.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Validators.ReferenceData
{
    ...
    /// <summary>
    /// A class to validate the <see cref="Category" />
    /// </summary>
    public class CategoryValidator : AbstractValidator<Category>
    {
        /// <summary>
        /// Instantiates a new <see cref="CategoryValidator" />
        /// </summary>
        /// <param name="validationService">The <see cref="IValidationService" /></param>
        public CategoryValidator(IValidationService validationService)
        {
