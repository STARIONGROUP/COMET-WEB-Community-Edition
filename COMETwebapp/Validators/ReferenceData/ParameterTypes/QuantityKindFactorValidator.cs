// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="QuantityKindFactorValidator.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Validators.ReferenceData.ParameterTypes
{
    ...
    /// </summary>
    public class QuantityKindFactorValidator : AbstractValidator<QuantityKindFactor>
    {
        /// <summary>
        ...
        public QuantityKindFactorValidator(IValidationService validationService)
        {
            ...
            this.RuleFor(x => x.QuantityKind).NotEmpty().Validate(validationService, nameof(QuantityKindFactor.QuantityKind));
        }
    }
}
