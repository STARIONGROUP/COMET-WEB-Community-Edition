// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="SpecializedQuantityKindValidator.cs" company="Starion Group S.A.">
...
namespace COMETwebapp.Validators.ReferenceData.ParameterTypes
{
    ...
    /// <summary>
    /// A class to validate the <see cref="SpecializedQuantityKind" />
    /// </summary>
    public class SpecializedQuantityKindValidator : AbstractValidator<SpecializedQuantityKind>
    {
        /// <summary>
        ...
        public SpecializedQuantityKindValidator(IValidationService validationService)
        {
            ...
            this.RuleFor(x => x.General).NotEmpty().Validate(validationService, nameof(SpecializedQuantityKind.General));
        }
    }
}
