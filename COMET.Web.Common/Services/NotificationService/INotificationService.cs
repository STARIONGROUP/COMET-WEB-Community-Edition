// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="INotificationService.cs" company="RHEA System S.A.">
...
namespace COMET.Web.Common.Services.NotificationService
{
    ...
    public interface INotificationService
    {
        ...
        void AddNotifications(int amount);

        /// <summary>
        /// Decreases the <see cref="NotificationService.NotificationCount"/>
        /// </summary>
        /// <param name="amount">The decrease amount</param>
        void RemoveNotifications(int amount);
    }
}
