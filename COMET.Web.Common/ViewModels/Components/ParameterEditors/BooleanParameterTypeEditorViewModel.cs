...
namespace COMET.Web.Common.ViewModels.Components.ParameterEditors
{
    ...
    public class BooleanParameterTypeEditorViewModel : ParameterTypeEditorBaseViewModel<BooleanParameterType>
    {
        ...
        /// <param name="isFromCompoundParameterType">A value indicating whether the current <see cref="BooleanParameterTypeEditorViewModel"/> is from <see cref="CompoundParameterType"/></param>
        public BooleanParameterTypeEditorViewModel(BooleanParameterType parameterType, IValueSet valueSet, bool isReadOnly, int valueArrayIndex = 0, ParameterSwitchKind compoundParameterSwitchKind = ParameterSwitchKind.MANUAL, bool isFromCompoundParameterType = false) : base(parameterType, valueSet, isReadOnly, valueArrayIndex, compoundParameterSwitchKind, isFromCompoundParameterType)
        {
        }
