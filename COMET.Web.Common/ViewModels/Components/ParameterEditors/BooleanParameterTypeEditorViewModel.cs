...
namespace COMET.Web.Common.ViewModels.Components.ParameterEditors
{
    ...
    public class BooleanParameterTypeEditorViewModel : ParameterTypeEditorBaseViewModel<BooleanParameterType>
    {
        ...
        public BooleanParameterTypeEditorViewModel(BooleanParameterType parameterType, IValueSet valueSet, bool isReadOnly, ParameterSwitchKind compoundParameterSwitchKind, int valueArrayIndex = 0) : base(parameterType, valueSet, isReadOnly, compoundParameterSwitchKind, valueArrayIndex)
        {
        }
