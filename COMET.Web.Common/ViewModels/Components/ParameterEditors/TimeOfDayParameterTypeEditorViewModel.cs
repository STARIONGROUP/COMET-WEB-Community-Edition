...
namespace COMET.Web.Common.ViewModels.Components.ParameterEditors
{
    ...
    public class TimeOfDayParameterTypeEditorViewModel : ParameterTypeEditorBaseViewModel<TimeOfDayParameterType>
    {
        ...
        /// <param name="isFromCompoundParameterType">A value indicating whether the current <see cref="TimeOfDayParameterTypeEditorViewModel"/> is from <see cref="CompoundParameterType"/></param>
        public TimeOfDayParameterTypeEditorViewModel(TimeOfDayParameterType parameterType, IValueSet valueSet, bool isReadOnly, int valueArrayIndex = 0, ParameterSwitchKind compoundParameterSwitchKind = ParameterSwitchKind.MANUAL, bool isFromCompoundParameterType = false) : base(parameterType, valueSet, isReadOnly, valueArrayIndex, compoundParameterSwitchKind, isFromCompoundParameterType)
        {
        }
