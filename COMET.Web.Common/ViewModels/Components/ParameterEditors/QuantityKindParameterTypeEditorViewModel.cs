...
namespace COMET.Web.Common.ViewModels.Components.ParameterEditors
{
    ...
    public class QuantityKindParameterTypeEditorViewModel : ParameterTypeEditorBaseViewModel<QuantityKind>
    {
        ...
        public QuantityKindParameterTypeEditorViewModel(QuantityKind parameterType, IValueSet valueSet, bool isReadOnly, ParameterSwitchKind compoundParameterSwitchKind, int valueArrayIndex = 0) : base(parameterType, valueSet, isReadOnly, compoundParameterSwitchKind, valueArrayIndex)
        {
        }
