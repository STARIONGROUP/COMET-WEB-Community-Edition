...
namespace COMET.Web.Common.ViewModels.Components.ParameterEditors
{
    ...
    public class TextParameterTypeEditorViewModel : ParameterTypeEditorBaseViewModel<TextParameterType>
    {
        ...
        public TextParameterTypeEditorViewModel(TextParameterType parameterType, IValueSet valueSet, bool isReadOnly, ParameterSwitchKind compoundParameterSwitchKind, int valueArrayIndex = 0) : base(parameterType, valueSet, isReadOnly, compoundParameterSwitchKind, valueArrayIndex)
        {
        }
