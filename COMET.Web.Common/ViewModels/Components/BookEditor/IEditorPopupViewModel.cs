// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="IEditorPopupViewModel.cs" company="Starion Group S.A.">
...
namespace COMET.Web.Common.ViewModels.Components.BookEditor
{
    ...
    /// </summary>
    public interface IEditorPopupViewModel
    {
        /// <summary>
