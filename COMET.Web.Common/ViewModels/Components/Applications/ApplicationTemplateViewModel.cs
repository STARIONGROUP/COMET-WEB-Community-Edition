// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="ApplicationTemplateViewModel.cs" company="Starion Group S.A.">
...
namespace COMET.Web.Common.ViewModels.Components.Applications
{
    ...
    /// <summary>
    /// Base ViewModel that will englobe all applications
    /// </summary>
    public class ApplicationTemplateViewModel : DisposableObject, IApplicationTemplateViewModel
    {
        /// <summary>
