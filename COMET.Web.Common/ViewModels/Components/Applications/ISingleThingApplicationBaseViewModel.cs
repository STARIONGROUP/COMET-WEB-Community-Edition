// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="ISingleThingApplicationBaseViewModel.cs" company="Starion Group S.A.">
...
namespace COMET.Web.Common.ViewModels.Components.Applications
{
    ...
    public interface ISingleThingApplicationBaseViewModel<TThing> : IApplicationBaseViewModel where TThing : Thing
    {
        /// <summary>
        /// The current <typeparamref name="TThing" />  to work with
        /// </summary>
        TThing CurrentThing { get; set; }
    }
}
