// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="ISingleIterationApplicationBaseViewModel.cs" company="Starion Group S.A.">
...
namespace COMET.Web.Common.ViewModels.Components.Applications
{
    ...
    /// </summary>
    public interface ISingleIterationApplicationBaseViewModel : ISingleThingApplicationBaseViewModel<Iteration>
    {
        /// <summary>
