// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="PublicationsViewModel.cs" company="Starion Group S.A.">
...
namespace COMET.Web.Common.ViewModels.Components.Publications
{
    ...
    public class PublicationsViewModel : DisposableObject, IPublicationsViewModel
    {
        ...
        private static List<PublicationRowViewModel> CreateRows(IEnumerable<ParameterOrOverrideBase> parameters)
        {
