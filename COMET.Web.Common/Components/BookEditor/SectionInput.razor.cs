// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="SectionInput.razor.cs" company="RHEA System S.A.">
...
namespace COMET.Web.Common.Components.BookEditor
{
    ...
    /// <summary>
    /// Support class for the SectionInput component
    /// </summary>
    public partial class SectionInput
    {
        /// <summary>
        /// Gets or sets the section for which the input is being provided
        /// </summary>
        [Parameter]
        ...
        {
            this.Section.Category = categories.ToList();
        }
    }
}
