// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="DateTimeParameterTypeEditor.razor.cs" company="Starion Group S.A.">
...
namespace COMET.Web.Common.Components.ParameterTypeEditors
{
    ...
    /// <summary>
    /// Component used to edit a <see cref="Parameter" /> defined with a <see cref="DateTimeParameterType" />
    /// </summary>
