// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="SingleEngineeringModelApplicationBase.razor.cs" company="Starion Group S.A.">
...
namespace COMET.Web.Common.Components.Applications
{
    ...
    /// <summary>
    /// Base component for any application that will need only one <see cref="EngineeringModel" />
    /// </summary>
    /// <typeparam name="TViewModel">An <see cref="ISingleEngineeringModelApplicationBaseViewModel" /></typeparam>
    public abstract partial class SingleEngineeringModelApplicationBase<TViewModel>
    {
        /// <summary>
        ...
        protected override void OnInitialized()
        {
            ...
            this.NumberOfUrlRequiredParameters = 2;
        }
