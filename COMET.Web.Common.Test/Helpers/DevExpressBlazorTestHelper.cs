// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="DevExpressBlazorTestHelper.cs" company="Starion Group S.A.">
...
namespace COMET.Web.Common.Test.Helpers
{
    ...
    public static class DevExpressBlazorTestHelper
    {
        ...
        public static void ConfigureDevExpressBlazor(this BunitContext context)
        {
            ...
            context.JSInterop.SetupVoid("DxBlazor.AdaptiveDropDown.init").SetVoidResult();
            context.JSInterop.SetupVoid("DxBlazor.Input.loadModule").SetVoidResult();
            context.JSInterop.SetupVoid("DxBlazor.UiHandlersBridge.loadModule").SetVoidResult();
        }
