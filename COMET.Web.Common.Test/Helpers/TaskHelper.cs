// --------------------------------------------------------------------------------------------------------------------
//  <copyright file="TaskHelper.cs" company="Starion Group S.A.">
...
namespace COMET.Web.Common.Test.Helpers
{
    ...
    /// <summary>
    /// Helper class for <see cref="Task" />
    /// </summary>
    ...
    public static class TaskHelper
    {
        ...
        /// <see cref="Task" />.
        /// </returns>
        public static async Task WaitWhileAsync(Func<bool> condition, int pollDelay = 25)
        {
            while (condition())
            {
        ...
        /// <see cref="Task" />.
        /// </returns>
        public static async Task WaitUntilAsync(Func<bool> condition, int pollDelay = 25)
        {
            while (!condition())
            {
                await Task.Delay(pollDelay).ConfigureAwait(true);
